...
const RegisterStudentModal = ({ onClose }) => {
  const [form, setForm] = useState({ lastName: '', firstName: '', classNumber: '', classLetter: '', username: '', password: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const classGroup = `${form.classNumber}${form.classLetter}`;
    ...
    <div style={overlayStyle}>
      <div style={modalStyle}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input name="classNumber" placeholder="Номер класса" onChange={handleChange} required />
          <input name="classLetter" placeholder="Литера" onChange={handleChange} required />
